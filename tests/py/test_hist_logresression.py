...
def test_single_tree_depth_2(double_precision, use_hist_trick, use_dynamic_parallelism, upload_features): run_regression(2, [0.5894128, 0.5894128, 0.5894128, 0.5894128, 0.5894128, 0.5894128,
...
@pytest.mark.parametrize("use_dynamic_parallelism", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_single_tree_depth_3(double_precision, use_hist_trick, use_dynamic_parallelism, upload_features): run_regression(3, [0.59668386, 0.59668386, 0.59668386, 0.59668386, 0.59668386, 0.59668386,
...
@pytest.mark.parametrize("use_dynamic_parallelism", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_2(double_precision, use_hist_trick, use_dynamic_parallelism, upload_features): run_regression(2, [0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
...
if __name__ == "__main__":
    pass
    # test_single_tree_depth_3(False, False, False)
    # run_regression(5, [0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
    #                    0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
    #                    0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
    #                    0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
    #                    0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412, 0.6638412,
    ...
    #                    0.3367726, 0.5166032, 0.5166032, 0.3367726, 0.3367726, 0.3367726,
    #                    0.48408338, 0.3367726, 0.3367726, 0.3367726, 0.3367726, 0.3367726,
    #                    0.3367726, 0.3367726, 0.3367726, 0.3367726, 0.3367726, 0.3367726], 1000)
