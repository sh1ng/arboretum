...
def test_single_tree_depth_1(double_precision): run_regression(1, [21.833334, 21.833334, 33.25,     33.25,     33.25,     33.25,     21.833334,
...
@pytest.mark.parametrize("double_precision", [True, False])
def test_single_tree_depth_2(double_precision): run_regression(2, [23.9,      23.9,      35.45,     31.050001, 35.45,     31.050001, 23.9,
                                                                   23.9,      17.7,      17.7], json.loads(
    '{"configuration": {"internals": {"compute_overlap": 2, "double_precision": true, "hist_size": 255, "seed": 0, "upload_features": true, "use_hist_subtraction_trick": true}, "method": 0, "objective": 0, "tree": {"alpha": 0.0, "colsample_bylevel": 1.0, "colsample_bytree": 1.0, "eta": 0.9999899864196777, "gamma_absolute": 0.0, "gamma_relative": 0.0, "initial_y": 0.5, "labels_count": 1, "lambda": 0.0, "max_depth": 3, "max_leaf_weight": 0.0, "min_child_weight": 2.0, "min_leaf_size": 2, "scale_pos_weight": 1.0}, "verbose": {"booster": false, "data": false, "gpu": false}}, "model": [{"nodes": [{"fid": 6, "id": 0, "leaf": false, "left": 1, "right": 2, "threshold": 65.19999694824219}, {"fid": 5, "id": 1, "leaf": false, "left": 3, "right": 4, "threshold": 7.146999835968018}, {"fid": 0, "id": 2, "leaf": false, "left": 5, "right": 6, "threshold": 0.17003999650478363}, {"id": 3, "idx": 0, "leaf": true}, {"id": 4, "idx": 1, "leaf": true}, {"id": 5, "idx": 2, "leaf": true}, {"id": 6, "idx": 3, "leaf": true}], "weights": [30.54969596862793, 34.949649810791016, 23.399765014648438, 17.1998291015625]}]}'), double_precision=double_precision)


@pytest.mark.parametrize("double_precision", [True, False])
def test_single_tree_depth_3(double_precision): run_regression(3, [22.8,      22.8,      35.45,     31.050001, 35.45,     31.050001, 25,
                                                                   25.,      17.7,      17.7], json.loads(
    '{"configuration": {"internals": {"compute_overlap": 2, "double_precision": true, "hist_size": 255, "seed": 0, "upload_features": true, "use_hist_subtraction_trick": true}, "method": 0, "objective": 0, "tree": {"alpha": 0.0, "colsample_bylevel": 1.0, "colsample_bytree": 1.0, "eta": 0.9999899864196777, "gamma_absolute": 0.0, "gamma_relative": 0.0, "initial_y": 0.5, "labels_count": 1, "lambda": 0.0, "max_depth": 4, "max_leaf_weight": 0.0, "min_child_weight": 2.0, "min_leaf_size": 2, "scale_pos_weight": 1.0}, "verbose": {"booster": false, "data": false, "gpu": false}}, "model": [{"nodes": [{"fid": 6, "id": 0, "leaf": false, "left": 1, "right": 2, "threshold": 65.19999694824219}, {"fid": 5, "id": 1, "leaf": false, "left": 3, "right": 4, "threshold": 7.146999835968018}, {"fid": 0, "id": 2, "leaf": false, "left": 5, "right": 6, "threshold": 0.17003999650478363}, {"fid": 0, "id": 3, "leaf": false, "left": 7, "right": 8, "threshold": null}, {"fid": 0, "id": 4, "leaf": false, "left": 9, "right": 10, "threshold": null}, {"fid": 0, "id": 5, "leaf": false, "left": 11, "right": 12, "threshold": 0.08828999847173691}, {"fid": 0, "id": 6, "leaf": false, "left": 13, "right": 14, "threshold": null}, {"id": 7, "idx": 0, "leaf": true}, {"id": 8, "idx": 1, "leaf": true}, {"id": 9, "idx": 2, "leaf": true}, {"id": 10, "idx": 3, "leaf": true}, {"id": 11, "idx": 4, "leaf": true}, {"id": 12, "idx": 5, "leaf": true}, {"id": 13, "idx": 6, "leaf": true}, {"id": 14, "idx": 7, "leaf": true}], "weights": [30.54969596862793, 0.0, 34.949649810791016, 0.0, 22.299776077270508, 24.499753952026367, 17.1998291015625, 0.0]}]}'), double_precision=double_precision)


@pytest.mark.parametrize("double_precision", [True, False])
def test_2trees_depth_1(double_precision): run_regression(1, [23.72778,  23.72778,  30.408333, 35.144444, 35.144444, 30.408333, 23.72778,
