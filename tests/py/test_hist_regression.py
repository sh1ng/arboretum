...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_2(double_precision, use_hist_trick, upload_features): run_regression(2, [[21.833334, 21.833334, 33.25,     33.25,     33.25,     33.25,     21.833334,
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_3(double_precision, use_hist_trick, upload_features): run_regression(3, [[23.9,      23.9,      35.45,     31.050001, 35.45,     31.050001, 23.9,
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_4(double_precision, use_hist_trick, upload_features): run_regression(4, [[22.8,      22.8,      35.45,     31.050001, 35.45,     31.050001, 25,
