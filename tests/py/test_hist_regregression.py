...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_single_tree_depth_3(double_precision, use_hist_trick, upload_features): run_regression(3, [[22.8,      22.8,      35.45,     31.050001, 35.45,     31.050001, 25,
                                                                                                     25.,      17.7,      17.7]],
                                                                                                json.loads(
    '{"configuration":{"internals":{"compute_overlap":2,"double_precision":false,"hist_size":12,"seed":0,"upload_features":false,"use_hist_subtraction_trick":false},"method":1,"objective":0,"tree":{"alpha":0.0,"colsample_bylevel":1.0,"colsample_bytree":1.0,"eta":0.9999899864196777,"gamma_absolute":0.0,"gamma_relative":0.0,"initial_y":0.5,"labels_count":1,"lambda":0.0,"max_depth":3,"max_leaf_weight":0.0,"min_child_weight":2.0,"min_leaf_size":2,"scale_pos_weight":1.0},"verbose":{"booster":false,"data":false,"gpu":false}},"model":[{"depth":4,"nodes":[{"fid":6,"id":0,"leaf":false,"left":1,"right":2,"threshold":63.14999771118164},{"fid":5,"id":1,"leaf":false,"left":3,"right":4,"threshold":7.072500228881836},{"fid":0,"id":2,"leaf":false,"left":5,"right":6,"threshold":0.15729498863220215},{"fid":0,"id":3,"leaf":false,"left":7,"right":8,"threshold":null},{"fid":0,"id":4,"leaf":false,"left":9,"right":10,"threshold":null},{"fid":0,"id":5,"leaf":false,"left":11,"right":12,"threshold":0.07866999506950378},{"fid":0,"id":6,"leaf":false,"left":13,"right":14,"threshold":null},{"id":7,"idx":0,"leaf":true},{"id":8,"idx":1,"leaf":true},{"id":9,"idx":2,"leaf":true},{"id":10,"idx":3,"leaf":true},{"id":11,"idx":4,"leaf":true},{"id":12,"idx":5,"leaf":true},{"id":13,"idx":6,"leaf":true},{"id":14,"idx":7,"leaf":true}],"weights":[30.54969596862793,0.0,34.94964599609375,0.0,22.299779891967773,24.499753952026367,17.199825286865234,0.0]}]}'),
    double_precision=double_precision,
    use_hist_trick=use_hist_trick,
    upload_features=upload_features)
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_1(double_precision, use_hist_trick, upload_features): run_regression(1, [[21.833334, 21.833334, 33.25,     33.25,     33.25,     33.25,     21.833334,
                                                                                                21.833334, 21.833334, 21.833334], [23.72778,  23.72778,  30.408333, 35.144444, 35.144444, 30.408333, 23.72778,
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_2(double_precision, use_hist_trick, upload_features): run_regression(2, [[23.9,      23.9,      35.45,     31.050001, 35.45,     31.050001, 23.9,
                                                                                                23.9,      17.7,      17.7], [23.575,    21.575,    35.125,    33.15,     37.550003, 28.725002, 23.566666,
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_3(double_precision, use_hist_trick, upload_features): run_regression(3, [[22.8,      22.8,      35.45,     31.050001, 35.45,     31.050001, 25,
                                                                                                25.,      17.7,      17.7], [23.5,      23.5,      35.2,      32.600002, 37,       28.825,    22.775,
                                                                                                                             25.7,      17.45,     17.45]],
                                                                                           json.loads(
    '{"configuration":{"internals":{"compute_overlap":2,"double_precision":false,"hist_size":12,"seed":0,"upload_features":false,"use_hist_subtraction_trick":false},"method":1,"objective":0,"tree":{"alpha":0.0,"colsample_bylevel":1.0,"colsample_bytree":1.0,"eta":0.9999899864196777,"gamma_absolute":0.0,"gamma_relative":0.0,"initial_y":0.5,"labels_count":1,"lambda":0.0,"max_depth":3,"max_leaf_weight":0.0,"min_child_weight":2.0,"min_leaf_size":2,"scale_pos_weight":1.0},"verbose":{"booster":false,"data":false,"gpu":false}},"model":[{"depth":4,"nodes":[{"fid":6,"id":0,"leaf":false,"left":1,"right":2,"threshold":63.14999771118164},{"fid":5,"id":1,"leaf":false,"left":3,"right":4,"threshold":7.072500228881836},{"fid":0,"id":2,"leaf":false,"left":5,"right":6,"threshold":0.15729498863220215},{"fid":0,"id":3,"leaf":false,"left":7,"right":8,"threshold":null},{"fid":0,"id":4,"leaf":false,"left":9,"right":10,"threshold":null},{"fid":0,"id":5,"leaf":false,"left":11,"right":12,"threshold":0.07866999506950378},{"fid":0,"id":6,"leaf":false,"left":13,"right":14,"threshold":null},{"id":7,"idx":0,"leaf":true},{"id":8,"idx":1,"leaf":true},{"id":9,"idx":2,"leaf":true},{"id":10,"idx":3,"leaf":true},{"id":11,"idx":4,"leaf":true},{"id":12,"idx":5,"leaf":true},{"id":13,"idx":6,"leaf":true},{"id":14,"idx":7,"leaf":true}],"weights":[30.54969596862793,0.0,34.94964599609375,0.0,22.299779891967773,24.499753952026367,17.199825286865234,0.0]},{"depth":4,"nodes":[{"fid":6,"id":0,"leaf":false,"left":1,"right":2,"threshold":56.45000076293945},{"fid":0,"id":1,"leaf":false,"left":3,"right":4,"threshold":null},{"fid":11,"id":2,"leaf":false,"left":5,"right":6,"threshold":396.25},{"fid":0,"id":3,"leaf":false,"left":7,"right":8,"threshold":null},{"fid":0,"id":4,"leaf":false,"left":9,"right":10,"threshold":null},{"fid":11,"id":5,"leaf":false,"left":11,"right":12,"threshold":393.4749755859375},{"fid":0,"id":6,"leaf":false,"left":13,"right":14,"threshold":null},{"id":7,"idx":0,"leaf":true},{"id":8,"idx":1,"leaf":true},{"id":9,"idx":2,"leaf":true},{"id":10,"idx":3,"leaf":true},{"id":11,"idx":4,"leaf":true},{"id":12,"idx":5,"leaf":true},{"id":13,"idx":6,"leaf":true},{"id":14,"idx":7,"leaf":true}],"weights":[1.5503146648406982,0.0,0.0,0.0,-0.2497628927230835,-2.2247025966644287,0.7002219557762146,0.0]}]}'),
    2,
    double_precision=double_precision,
    use_hist_trick=use_hist_trick,
    upload_features=upload_features)
