...
def test_single_tree_depth_2(double_precision, use_hist_trick, upload_features): run_regression(2, [[0.59668386, 0.59668386, 0.59668386, 0.59668386, 0.59668386, 0.59668386,
...
@pytest.mark.parametrize("use_hist_trick", [True, False])
@pytest.mark.parametrize("upload_features", [True, False])
def test_2trees_depth_1(double_precision, use_hist_trick, upload_features): run_regression(1, [[0.5894128, 0.5894128, 0.5894128, 0.5894128, 0.5894128, 0.5894128,
...
if __name__ == "__main__":
    pass
    # test_2trees_depth_1(False, False, False)
