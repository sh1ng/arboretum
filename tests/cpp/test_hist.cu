...
TEST(HistTreeGrower, CreatePartitioningIndexes) {
  ...
  ASSERT_EQ(partitioning_indexes[1], 2);
  ASSERT_EQ(partitioning_indexes[2], 4);
  ASSERT_EQ(partitioning_indexes[3], 6);
  ASSERT_EQ(partitioning_indexes[4], 8);
  ASSERT_EQ(partitioning_indexes[5], 10);
  ASSERT_EQ(partitioning_indexes[6], 12);
  ASSERT_EQ(partitioning_indexes[7], 14);
  ASSERT_EQ(partitioning_indexes[8], 16);
  ASSERT_EQ(partitioning_indexes[9], 18);
  ASSERT_EQ(partitioning_indexes[10], 20);
  ASSERT_EQ(partitioning_indexes[11], 22);
  ASSERT_EQ(partitioning_indexes[12], 24);
  ASSERT_EQ(partitioning_indexes[13], 26);
  ASSERT_EQ(partitioning_indexes[14], 28);
  ASSERT_EQ(partitioning_indexes[15], 30);
  ASSERT_EQ(partitioning_indexes[16], 31);
  ASSERT_EQ(partitioning_indexes[17], 29);
  ASSERT_EQ(partitioning_indexes[18], 27);
  ASSERT_EQ(partitioning_indexes[19], 25);
  ASSERT_EQ(partitioning_indexes[20], 23);
  ASSERT_EQ(partitioning_indexes[21], 21);
  ASSERT_EQ(partitioning_indexes[22], 19);
  ASSERT_EQ(partitioning_indexes[23], 17);
  ASSERT_EQ(partitioning_indexes[24], 15);
  ASSERT_EQ(partitioning_indexes[25], 13);
  ASSERT_EQ(partitioning_indexes[26], 11);
  ASSERT_EQ(partitioning_indexes[27], 9);
  ASSERT_EQ(partitioning_indexes[28], 7);
  ASSERT_EQ(partitioning_indexes[29], 5);
  ASSERT_EQ(partitioning_indexes[30], 3);
  ASSERT_EQ(partitioning_indexes[31], 1);
}
...
TEST(HistTreeGrower,
  ...
  grower.ProcessDenseFeature<unsigned int>(
    partitioning_indexes, row2Node, grad, fvalue_d,
    thrust::raw_pointer_cast(fvalue_h.data()), parent_node_sum,
    parent_node_count, 3, level, depth, p, true, 0);
  TEST_OK(cudaStreamSynchronize(grower.stream));
  TEST_OK(cudaStreamSynchronize(grower.copy_d2h_stream));
